...
def main():
    ...
    def show_date():
        ...
        tk.Label(mainWindow, text = today[0] + ' ' + today[2] + ' ' + today[1] + ' ' + today[4], fg ='#B3B6B7', font = ('DS-DIGIB.TTF', 25)).place(x = 150, y = 220)
    ...
    def show_calendar(mainWindow, currentMonth, currentYear):
        ...
        s=0
        while s < len(week_days):
            tk.Label(mainWindow, text = week_days[s], fg ='#979A9A', font = ('DS-DIGIB.TTF', 12)).place(x = a + 600, y = 60)
            a += 50
            s += 1   
